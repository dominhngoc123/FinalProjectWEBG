 ...
 */
final class Version20211229161744 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE order_detail (id INT AUTO_INCREMENT NOT NULL, book_id INT DEFAULT NULL, order_id INT DEFAULT NULL, current_price DOUBLE PRECISION NOT NULL, quantity SMALLINT NOT NULL, INDEX IDX_ED896F4616A2B381 (book_id), INDEX IDX_ED896F468D9F6D38 (order_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
