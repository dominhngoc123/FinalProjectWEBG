...
class TypeFixtures extends Fixture
{
    public function load(ObjectManager $manager): void
    {
        ...
        $type->setCreateBy('Bùi Thị Trang');
        ...
        $type1->setCreateBy('Bùi Thị Trang');
        ...
        $type2->setCreateBy('Bùi Thị Trang');
        ...
        $type3->setCreateBy('Bùi Thị Trang');
        ...
        $type4->setCreateBy('Bùi Thị Trang');
